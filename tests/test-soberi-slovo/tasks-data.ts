...
// Фразы и картинки из test-01-mame
export const tasks: PhraseToImageItem[] = [
  ...
  { id: 6, phrase: "Грибник несёт корзину", mediaPath: "/tests/test-01-mame/images/07-mushroom-picker-basket1.jpg" },
  { id: 7, phrase: "Пекарь раскатывает тесто", mediaPath: "/tests/test-01-mame/images/09-baker-dough1.jpg" },
  { id: 8, phrase: "Хозяйка вытирает пыль", mediaPath: "/tests/test-01-mame/images/12-housewife-dust1.jpg" },
];
